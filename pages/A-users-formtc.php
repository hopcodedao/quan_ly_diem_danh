...
<div class="container">
  ...
  <div class="bg-white border p-4 my-3">
    ...
    <div class="form-floating mb-2">
      <input type="text" class="form-control" id="user_mssv" required value="<?= isset($user) ? $user["user_mssv"] : "" ?>">
      <label>Mã số</label>
    </div>

    <div class="form-floating mb-2">
      <input type="date" class="form-control" id="user_birthdate" required value="<?= isset($user) ? $user["user_birthdate"] : "" ?>">
      <label>Ngày sinh</label>
    </div>

    <div class="form-floating mb-2">
      <input type="text" class="form-control" id="user_phonenumber" required value="<?= isset($user) ? $user["user_phonenumber"] : "" ?>">
    ...
    <div class="form-floating mb-2">
      <input type="text" class="form-control" id="user_address" required value="<?= isset($user) ? $user["user_address"] : "" ?>">
      <label>Địa chỉ</label>
    </div>
