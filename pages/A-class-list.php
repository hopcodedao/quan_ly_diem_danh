  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-dark">
      <li class="dropdown-item" onclick="classes.addEdit('<?=$id?>')">
        <i class="text-secondary ico-sm icon-pencil"></i> Chỉnh sửa
      </li>
      <li class="dropdown-item" onclick="attend.show(<?=$id?>)">
        <i class="text-secondary ico-sm icon-users"></i> Danh sách điểm danh
      </li>
      <li><a class="dropdown-item" target="_blank" href="<?=HOST_BASE?>TA/classqr?c=<?=$id?>">
        <i class="text-secondary ico-sm icon-qrcode"></i> Tạo Mã QR
      </a></li>
      <li class="dropdown-item text-warning" onclick="classes.del('<?=$id?>')">
        <i class="ico-sm icon-bin2"></i> Xóa
      </li>
    </ul>
  </div>
</div>
