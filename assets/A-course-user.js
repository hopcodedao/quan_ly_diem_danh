var cuser = {
  ...
  addAllUsers: () => {
    cb.api({
      mod: "courses",
      act: "addAllUsers", // Gọi hàm mới ở backend
      data: {
        code: cuser.code,
      },
      passmsg: "Tất cả người dùng đã được thêm vào khóa học",
      onpass: cuser.list,
    });
  },
  ...
  del: (id) =>
    cb.modal(
      "Please confirm",
      "User will be removed from the course, but past attendance will be kept.",
      () =>
        cb.api({
          mod: "courses",
          act: "delUser",
